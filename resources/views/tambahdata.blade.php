...
<body>
    <h1 class="text-center mb-4">Tambah data anda dan barang yang akan dipesan</h1>
                ...
                <div class="card-body">
                    <form action="/insertdata" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                          ...
                          <div class="mb-3">
                            <!-- Contoh input untuk kolom tambahan -->
                        ...
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">RT_RW</label>
                            <input type="text" name="RT_RW" class="form-control">
                        </div>

                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Foto_KTP</label>
